      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/about" className="leading-7 [&:not(:first-child)]:mt-6">
                About Us
              </Link>
            </li>
            <li>
              <Link href="/contact" className="leading-7 [&:not(:first-child)]:mt-6">
                Contact
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/privacy" className="leading-7 [&:not(:first-child)]:mt-6">
                Privacy Policy
              </Link>
            </li>
            <li>
              <Link href="/terms" className="leading-7 [&:not(:first-child)]:mt-6">
                Terms of Service
              </Link>
            </li>
          </ul>
