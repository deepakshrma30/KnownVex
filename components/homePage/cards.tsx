    ...
    <div>
      <section className="py-16">
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-4xl font-black mt-2 ">WHAT STYLE OF PROGRAMS</h1>
            ...
            {cardData?.map((item, index) => (
              <Card
                ...
                className={cn(
                  ...
                  { "mt-6": index % 2 !== 0 , "bg-[#807AF9] text-white":index===0}
                )}
              >
                <CardHeader>
                  <div className="flex items-centre justify-start mb-4">
                    <span className={cn("inline-block p-3 rounded-full bg-[#FFEFDD] text-purple-500",{"bg-white":index===0})}>
